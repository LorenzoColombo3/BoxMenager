...
public class CustomersController {
    ...
    @PostMapping("/{customerId}/removeUnit")
    public String removeBox(@RequestParam Long customerId, @RequestParam int boxId, HttpServletRequest httpRequest) {
        Company user= (Company) httpRequest.getSession().getAttribute("user");
        customerDetailViewModel.removeUnit(user.getUid(), String.valueOf(customerId), String.valueOf(boxId));
        return "redirect:/customers";  
    }
